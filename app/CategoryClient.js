...
export default function CategoryClient({ title, description, products }) {
    ...
    <div className="page-enter">
      ...
      <section style={{ padding: '3rem 6%', maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <h1 className="text-display font-serif fade-in">{title}</h1>
          <p className="fade-in stagger-1" style={{ color: 'var(--on-surface-variant)', marginTop: '1rem', maxWidth: '600px', margin: '1rem auto 0', lineHeight: '1.6' }}>
            {description}
          </p>
        </div>
